    ...
    <div className="px-[12%] pt-10 pb-14 font-sans bg-white text-[#231f20]">
        ...
        <div id="500mega"className="shadow-[0px_0px_10px_10px_rgba(80,80,80,0.1)] w-[31%] rounded-3xl">
            <div className="rounded-t-3xl border-b-0 border-gray-200 border-[2px] px-6 pt-8 pb-3">
                ...
                <button className="py-3 bg-[#9c0004] text-white w-full rounded-full text-xl mt-2 mb-1">Aproveitar oferta</button>
                ...
                <div className="rounded-b-3xl border-t-0 border-gray-200 border-[2px] px-6 py-6 bg-[#f4f5f5]">
        ...
        <div className="my-10 w-full pt-0.5 bg-[#d1d3d4]"></div>
        ...
        <div id="radio"className="shadow-[0px_0px_10px_10px_rgba(80,80,80,0.1)] w-[31%] rounded-3xl">
            <div className="rounded-3xl border-gray-200 border-[2px] px-6 pt-8 pb-8">
                ...
                <button className="py-3 bg-[#9c0004] text-white w-full rounded-full text-xl mt-2">Conhecer Oferta</button>
            </div>
        </div>
