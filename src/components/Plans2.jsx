  ...
  return (
    <div id='Plans' className="px-6 sm:px-[8%] md:px-[12%] pt-10 pb-14 font-sans bg-[#f4f5f5] text-[#231f20]">
      ...
      <div id="700mega" className="shadow-[0px_0px_7px_7px_rgba(80,80,80,0.07)] w-full md:w-[31%] rounded-3xl">
        ...
        <div id="600mega" className="shadow-[0px_0px_7px_7px_rgba(80,80,80,0.1)] w-full md:w-[31%] rounded-3xl relative">
  <div className="rounded-t-3xl border-b-0 border-gray-200 border-[2px] px-6 pt-8 pb-3 bg-black">
    <h1 className="text-4xl sm:text-4xl bg-gradient-to-r from-[#c48621] via-[#efd86d] to-[#c48621] inline-block text-transparent bg-clip-text">600 mega</h1>
    
    {/* Posiciona a imagem no canto superior direito */}
    <img src="img/black friday etiqueta.png" alt="" className="absolute top-3 right-5 w-28" />

    <h2 className="text-lg bg-gradient-to-r from-[#c48621] via-[#efd86d] to-[#c48621] text-transparent bg-clip-text">Leve + 100 mega de bônus</h2>
    <p className="text-3xl sm:text-4xl font-medium text-[#fff] mt-2 mb-1">
    ...
    <p className="text-base sm:text-lg text-[#fff] mt-2">Wi-Fi 6 grátis - Mais conectividade</p>
    <p className="text-base sm:text-lg text-[#fff]">Instalação grátis | Sem fidelidade</p>
  </div>
  <div className="rounded-b-3xl border-t-0 border-gray-200 border-[2px] px-6 py-6 bg-[#303030]">
    <p className="flex flex-row items-center gap-2 text-base sm:text-lg text-[#fff]">
      <IoIosWifi /> 1 Ponto <span className="text-[#fff]">Wi-Fi 6</span> incluído
    </p>
  </div>
</div>
