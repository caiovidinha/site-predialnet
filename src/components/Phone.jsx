...
function Phone() {
  return (
    <div className="px-[12%] pt-10 pb-14 font-sans bg-[#f4f5f5] text-[#231f20]">
        ...
        <h2 className="text-[#808080] text-xl">A melhor internet fibra também</h2>
        <h2 className="text-[#808080] text-xl -mt-1 ">é a melhor telefonia fixa</h2>
        ...
        <h1 className="text-4xl">Ideal Plus</h1>
                ...
                <p className="text-lg text-[#808080] mt-2">2000 minutos fixo/fixo local</p>
                <p className="text-lg text-[#808080] ">100 minutos para qualquer móvel local</p>
            </div>
            ...
            <div id="master" className="shadow-[0px_0px_7px_7px_rgba(80,80,80,0.07)] w-[31%] rounded-3xl p-5 flex flex-col justify-around">
                ...
                <button className="py-3 bg-[#9c0004] text-white w-full rounded-full text-xl mt-2 font-light mb-1 hover:scale-105 transition-transform">Aproveitar oferta</button>
                <p className="text-lg text-[#808080] mt-2">Ilimitado fixo/fixo local</p>
                <p className="text-lg text-[#808080]">200 minutos para qualquer móvel local</p>
